# Hi, I'm Lungelwa Mazibuko

**Junior Backend Developer | C#/.NET | SQL Server | REST APIs**

I'm a Software Development student based in South Africa, focused on backend development, database design, APIs, and reliable software systems.

Currently working with **C#, .NET, Java, SQL Server, REST APIs, Docker, Azure, and GitHub Actions**.
